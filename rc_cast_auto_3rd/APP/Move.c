...
//                                        X     Y     Z
PathParam_t PathParam_LockPoint = {.Kp = {4.75, 4.75, 5.00}, 
                                   .Ki = {0.40, 0.40, 0.40}, 
                                   .Kd = {0.00, 0.00, 0.00}, 
                                   .Limit = {1.25, 1.25, 90}};
...
PathParam_t PathParam_SZ_TZ1 =    {.P0 = {0.55, 7.54, -90.00}, 
                                   ...
                                   .Kd = {0.00, 0.00, 0.00}, 
                                   .Limit = {4.75, 4.75, 90}, 
                                   .Duration = 2800}; //2700 //2900

PathParam_t PathParam_TZ1_TZ2 =   {.P0 = {2.82, 3.02, -14.00}, 
                                   .P1 = {0.40, 2.82, -7.00}, 
                                   .P2 = {0.40, 0.82, 0.00}, 
                                   .P3 = {3.78, 1.02, 0.00}, 
                                   .Kp = {2.75, 2.65, 5.00}, 
                                   ...
                                   .Kd = {0.00, 0.00, 0.00}, 
                                   .Limit = {4.75, 4.75, 90}, 
                                   .Duration = 3000}; //2400 //2950 //3400

PathParam_t PathParam_TZ2_TZ3 =   {.P0 = {3.78, 1.02, 0.00}, 
                                   .P1 = {3.78, 1.02, -1.00}, 
                                   .P2 = {7.08, 1.02, -1.00}, 
                                   .P3 = {7.08, 1.02, -1.00}, 
                                   .Kp = {2.25, 2.50, 5.00}, 
...
PathParam_t PathParam_TZ3_SZ =    {.P0 = {7.08, 1.02, -1.00}, 
                                   .P1 = {0.00, 1.02, 0.00}, 
                                   .P2 = {0.85, 0.00, 0.00}, 
                                   .P3 = {0.85, 7.54, 0.00}, 
                                   .Kp = {2.00, 2.00, 5.00}, 
...
bool Move_Relocate()
{
    ...
    if (fabs(PosX - DT352RealX) < 0.30 && fabs(PosY - DT352RealY) < 0.30)
    {
        GyroEncoder_Off();
        delay_ms(5);
        PosX = DT352RealX;
