...
RingBuf_t USB_RingBuf;
uint8_t isUSBAvailable = 0;
...
static uint16_t VCP_Init(void)
{
    USB_RingBuf = RingBuf_Create(8, 1);
    return USBD_OK;
}
...
static uint16_t VCP_Ctrl (uint32_t Cmd, uint8_t* Buf, uint32_t Len)
{
    switch (Cmd)
    {
        ...
        printf("> VCP Ctrl: SEND_ENCAPSULATED_COMMAND\r\n");
        break;
        
        case GET_ENCAPSULATED_RESPONSE:
        printf("> VCP Ctrl: GET_ENCAPSULATED_RESPONSE\r\n");
        break;
        
        case SET_COMM_FEATURE:
        printf("> VCP Ctrl: SET_COMM_FEATURE\r\n");
        break;
        
        case GET_COMM_FEATURE:
        printf("> VCP Ctrl: GET_COMM_FEATURE\r\n");
        break;
        
        case CLEAR_COMM_FEATURE:
        printf("> VCP Ctrl: CLEAR_COMM_FEATURE\r\n");
        break;
        
        case SET_LINE_CODING:
        printf("> VCP Ctrl: SET_LINE_CODING\r\n");
        break;
        
        case GET_LINE_CODING:
        printf("> VCP Ctrl: GET_LINE_CODING\r\n");
        if (Len == 7 && Buf[6] == 0x08) isVCPAvailable = 1;
        break;
        
        case SET_CONTROL_LINE_STATE:
        printf("> VCP Ctrl: SET_CONTROL_LINE_STATE\r\n");
        isVCPAvailable = 0;
        break;
        
        case SEND_BREAK:
        printf("> VCP Ctrl: SEND_BREAK\r\n");
        break;
        
        default:
        printf("> VCP Ctrl: UNKNOWN\r\n");
        break;
    }
    printf("            ");
